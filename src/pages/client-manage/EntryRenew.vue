<template>
  <div>
    <slider-form :formGroups="formGroups"></slider-form>
  </div>
</template>
  ...
  data() {
    return {
      formGroups: [
        ...
        FormItem.createText('开通时间', 'startDate'),
        FormItem.createText('客户编码', 'bossNum'),
        FormItem.createText('备注', 'remark'),
        FormItem.createText('续费时间', 'RenewDate')
